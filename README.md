About pmda-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pmda-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/MDAnalysis/pmda
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4094&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pmda-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pmda` can be installed with `conda`:
...
It is possible to list all of the versions of `pmda` available on your platform with `conda`:
...
```
mamba search pmda --channel conda-forge
```
...
mamba repoquery search pmda --channel conda-forge

# List packages depending on `pmda`:
mamba repoquery whoneeds pmda --channel conda-forge

# List dependencies of `pmda`:
mamba repoquery depends pmda --channel conda-forge
```
